...
`const person = {
    ...
    location: "Asia/Korea", // Expecting the IANA time zone identifier, e.g., 'Europe/Vienna'
...
`const home = {
    label: "Home",
    title: "영진's Portfolio",
    description: "Portfolio website showcasing my work as a Design Engineer",
    headline: <>Design engineer and builder</>,
    subline: (
      <>
        아이엠드론, a design engineer at <InlineCode>FLY</InlineCode>, where I craft intuitive
